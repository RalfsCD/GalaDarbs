    ...
    <div class="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-4">
      <div class="max-w-2xl space-y-2">
        <div class="inline-flex items-center gap-2">
          ...
          <span class="text-[11px] font-semibold tracking-wide uppercase text-yellow-900/80 dark:text-yellow-100/90">New topic</span>
        </div>
        ...
        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">
          Name your topic and (optionally) add a short description so people know why to follow it.
        </p>
      </div>
    ...
    <div class="rounded-3xl bg-white/80 dark:bg-gray-900/70 backdrop-blur border border-gray-200/70 dark:border-gray-800/70 shadow-[0_16px_44px_-22px_rgba(0,0,0,0.45)] p-4 sm:p-6 space-y-6">
      ...
      <div class="space-y-2">
        ...
        <div class="flex items-center gap-2 text-xs text-gray-500 dark:text-gray-400">
          ...
          Tip: one or two sentences is perfect.
        </div>
      </div>
