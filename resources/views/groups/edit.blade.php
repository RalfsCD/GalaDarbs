    ...
    <ol class="flex items-center flex-wrap gap-1.5 text-xs sm:text-sm text-gray-600 dark:text-gray-300">
      ...
      <li>
        <a href="{{ route('groups.show', $group) }}"
           class="inline-flex items-center gap-1 px-2 py-1 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition">
          <span class="font-semibold truncate max-w-[50vw]">{{ $group->name }}</span>
        </a>
      </li>
      <li aria-hidden="true" class="text-gray-400">
        <svg class="w-3.5 h-3.5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
      ...
      <li class="text-gray-900 dark:text-gray-100 font-semibold">Edit</li>
    </ol>
  </nav>
    ...
    <div class="relative z-10 flex flex-col md:flex-row md:items-start md:justify-between gap-4">
      <div class="max-w-2xl space-y-2">
        <div class="inline-flex items-center gap-2">
          ...
          <span class="text-[11px] font-semibold tracking-wide uppercase text-yellow-900/80 dark:text-yellow-100/90">Update group</span>
        </div>
        ...
        <p class="text-sm sm:text-base text-gray-600 dark:text-gray-400">
          Change the name, description, and topics to keep your community accurate and discoverable.
        </p>
      </div>
    ...
    <div class="rounded-3xl bg-white/80 dark:bg-gray-900/70 backdrop-blur border border-gray-200/70 dark:border-gray-800/70 shadow-[0_16px_44px_-22px_rgba(0,0,0,0.45)] p-4 sm:p-6 space-y-6">
      ...
      <div class="space-y-2">
        ...
        <textarea id="description" name="description" rows="4"
                  ...
                  class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-950/70 text-gray-900 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-yellow-300 dark:focus:ring-yellow-600 shadow-sm">{{ old('description', $group->description) }}</textarea>
