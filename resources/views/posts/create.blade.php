...
<div class="max-w-7xl mx-auto p-6 space-y-6">
    ...
    <div class="p-6 rounded-2xl bg-white dark:bg-gray-800 shadow-md flex items-center justify-between">
        <h1 class="text-4xl font-extrabold text-gray-900 dark:text-gray-100">
            Create Post in <span class="text-yellow-500">{{ $group->name }}</span>
        </h1>
    </div>
            ...
            <div>
                ...
                <input type="text" name="title" id="title" value="{{ old('title') }}"
                    class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 
                           ...
                           focus:ring-yellow-400 dark:focus:ring-yellow-600" placeholder="Enter post title">
            </div>
            ...
            <div>
                ...
                <textarea name="content" id="content" rows="5"
                          class="w-full px-4 py-2.5 rounded-xl border border-gray-300 dark:border-gray-600 
                                 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 
                                 placeholder-gray-400 focus:outline-none focus:ring-2 
                                 focus:ring-yellow-400 dark:focus:ring-yellow-600" placeholder="Write your post content...">{{ old('content') }}</textarea>
            </div>
