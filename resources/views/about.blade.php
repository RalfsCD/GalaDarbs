...
<main class="bg-gray-100 min-h-screen pt-6 px-6">
    <!-- Container centered and max-width -->
    <div class="max-w-4xl mx-auto space-y-10">
        ...
        <section x-data="{ open: false }" class="space-y-2">
            <button @click="open = !open" class="flex items-center justify-between w-full text-2xl font-bold mb-2 px-4 py-2 rounded bg-white text-gray-900 hover:bg-gray-200 transition">
